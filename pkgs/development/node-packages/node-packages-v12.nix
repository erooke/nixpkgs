...
let
  sources = {
    ...
    "minipass-3.1.2" = {
      ...
      version = "3.1.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/minipass/-/minipass-3.1.2.tgz";
        sha512 = "1UelkoRxUOd3d3VOKu2YIgwqhnLaBRpPyqiCpLFOesz5gqEMS8ryTnrzbge1J6C4LBKecr9eKb1FD6INXvWssw==";
      };
    };
    "minizlib-1.3.3" = {
      name = "minizlib";
